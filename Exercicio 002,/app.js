...
console.log(n1*n2) // * operador de multi´licação
...
console.log(n1%n2) // % operador de modulo, pega o resto da divisão
document.getElementById("resultado_modulo").innerText = n1%n2

console.log(n1**n2) // ** operador de exponenciação, pega um numero e eleva a 10
document.getElementById("resultado_exponenciacao").innerText = n1**n2